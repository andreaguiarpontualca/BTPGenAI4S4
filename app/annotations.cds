using { andreAguiar_3_H03Srv } from '../srv/service.cds';

annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate andreAguiar_3_H03Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate andreAguiar_3_H03Srv.CustomerMessage with {
...
annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.LineItem: [
...
annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate andreAguiar_3_H03Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
