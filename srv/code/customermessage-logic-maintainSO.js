...
/**
 * customermessage-logic-maintainSO
 * @On(event = { "Action2" }, entity = "andreAguiar_3_H03Srv.CustomerMessage")
...
module.exports = async function (request) {
	...
	const suggestedResponseEnglish = customerMessage.SUGGESTEDRESPONSEENGLISH;
	const attachedSOId = customerMessage.S4HCP_SERVICEORDER_SERVICEORDER;
