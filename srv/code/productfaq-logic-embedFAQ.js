...
/**
* productfaq-logic-embedFAQ
 * @After(event = { "CREATE","UPDATE" }, entity = "andreAguiar_3_H03Srv.ProductFAQ")
...
module.exports = async function (results, request) {
	...
	try {
		...
		productFAQ = await SELECT.one('andreAguiar_3_H03.ProductFAQ').where({ ID: productFAQID }).forUpdate();
		if (!productFAQ) {
